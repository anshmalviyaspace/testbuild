...
export const ScrollStackItem = ({ children, itemClassName = '' }: { children: React.ReactNode; itemClassName?: string }) => (
  <div
    className={`scroll-stack-card relative w-full min-h-80 my-8 p-8 sm:p-12 rounded-[32px] shadow-[0_0_30px_rgba(0,0,0,0.3)] box-border origin-top will-change-transform bg-card border border-border ${itemClassName}`.trim()}
    style={{
...
const ScrollStack = ({
  ...
  return (
    <div className={containerClassName} ref={scrollerRef} style={containerStyles}>
      <div className="scroll-stack-inner px-4 sm:px-8 lg:px-20 pb-[30rem]">
        {children}
